      ...
      for (let j = 0; j < inputValue.length; j++) {
        ...
        if (String(splitMessage[j]) === upperLetter) {
          ...
          //we then append add it to the new string
            ...
            letterIndex = alphabet.indexOf(lower)

            cipherLetter = String(cipherAlpha[letterIndex]).toUpperCase()
        ...
        //append the letter to the new string
          ...
          letterIndex = alphabet.indexOf(splitMessage[j])

          cipherLetter = String(cipherAlpha[letterIndex])
